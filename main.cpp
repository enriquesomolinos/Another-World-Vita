...
#ifdef PSVITA
	static const int DEFAULT_WINDOW_W = 960;
	static const int DEFAULT_WINDOW_H = 544;
#else
...
int main(int argc, char *argv[])
{
	...
	#ifdef PSVITA
		Graphics *graphics = createGraphics(GRAPHICS_SOFTWARE);
	#else
	...
	SystemStub *stub = SystemStub_SDL_create();
		...
		sceIoMkdir("ux0:data/SOMO00002", 0755);
		Engine *e = new Engine(graphics, stub, "ux0:data/SOMO00002", part);
	#else
